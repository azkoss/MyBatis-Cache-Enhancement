...
public class XXMLConfigBuilder extends BaseBuilder {
    ...
    private XXMLConfigBuilder(XPathParser parser, String environment, Properties props) {
        super(new XConfiguration());
